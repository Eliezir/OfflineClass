...
/** A menu row inside a Popover — icon chip + title + optional caption + optional trailing slot. */
...
function PopoverSeparator({ className, ...props }: React.ComponentProps<'div'>): React.JSX.Element {
  return (
    <div
...
function PopoverTitle({ className, ...props }: React.ComponentProps<'div'>): React.JSX.Element {
  return (
    <div
